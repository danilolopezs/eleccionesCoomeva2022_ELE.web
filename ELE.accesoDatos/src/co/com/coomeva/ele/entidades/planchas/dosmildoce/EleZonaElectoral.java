...
public class EleZonaElectoral implements java.io.Serializable {
	...
	/** default constructor */
	public EleZonaElectoral() {
	}

	/** minimal constructor */
	public EleZonaElectoral(String codigoZonaEle) {
		this.codigoZonaEle = codigoZonaEle;
	}

	/** full constructor */
	public EleZonaElectoral(String codigoZonaEle, String descripcionZonaEle,
