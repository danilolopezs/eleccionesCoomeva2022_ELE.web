...
public class EleInhabilidad  implements java.io.Serializable {
    ...
    public EleInhabilidad(Long consecutivoInhabilidad, EleProcesoRegla eleProcesoRegla, EleAsociado eleAsociado, String observaciones, Long valorMoraFin, Long valorMoraMul) {
       this.consecutivoInhabilidad = consecutivoInhabilidad;
