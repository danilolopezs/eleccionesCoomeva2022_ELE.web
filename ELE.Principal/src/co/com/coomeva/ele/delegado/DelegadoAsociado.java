...
public class DelegadoAsociado {
	...
	/**
	 * Verifica si en el sistema hay un asociado con la cédula o id pasado como
	 * parámetro
	 * 
	 * @author <a href="mailto:javiero.londono@premize.com">Javier Londoño</a> -
	 *         Premize SAS <br>
	...
	/**
	 * Metodo encargado de consultar el total de asociados hábiles a la fecha
	 */
	...
	/**
	 * Metodo encargado de consultar el total de asociados hábiles a la fecha por
	 * zona
	 */
	 ...
	 * fecha
	 */
	public boolean existAsociadoEspecial(String nroCabIdentificacion) throws Exception {
		return logicaAsociado.existAsociadoEspecial(nroCabIdentificacion);
	}
}