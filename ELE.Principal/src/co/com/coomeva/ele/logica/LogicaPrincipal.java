...
public class LogicaPrincipal extends ElePrincipalesDAO {
	 ...
	 * @throws Exception
	 */
	public void crearPrincipalPlancha(String nroPriIdentificacion, String nroCabPlancha, String primerNombre,
			String segundoNombre, String primerApellido, String segundoApellido, String profesion, String email,
			Long orden) throws Exception {
	...
	public void crearPrincipales(List<ElePrincipalesDTO> listaPrincipales) throws Exception {
		...
		for (ElePrincipalesDTO elePrincipalesDTO : listaPrincipales) {
			...
			DelegadoPrincipal.getInstance().crearPrincipalPlancha(elePrincipalesDTO.getNroPriIdentificacion(),
					elePrincipalesDTO.getElePlanchas().getNroCabPlancha(), elePrincipalesDTO.getPrimerNombre(),
					elePrincipalesDTO.getSegundoNombre(), elePrincipalesDTO.getPrimerApellido(),
					elePrincipalesDTO.getSegundoApellido(), elePrincipalesDTO.getProfesion(),
					elePrincipalesDTO.getEmail(), cont);
