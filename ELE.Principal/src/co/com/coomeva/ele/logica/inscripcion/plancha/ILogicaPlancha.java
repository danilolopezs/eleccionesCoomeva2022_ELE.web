...
public interface ILogicaPlancha {
	 ...
	 */
	List<DTOMiembroPlancha> adicionarMiembroPlancha(List<DTOMiembroPlancha> miembros, Long numeroDocumento,
	 ...
	 * @throws EleccionesDelegadosException
	 */
	DTOInformacionPlancha consultarInformacionPlancha(Long consecutivoPlancha) throws EleccionesDelegadosException;
	...
	String validarEmpleadoFechaRetiro(Long numeroDocumento) throws EleccionesDelegadosException;
