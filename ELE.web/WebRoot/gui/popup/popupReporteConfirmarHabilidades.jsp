<ice:panelPopup id="confirmarPopup" draggable="true"
	visible="#{generarReportesHabilidadesVista.visibleConfirmar}" modal="true"
	...
	<f:facet name="body">
		<ice:panelGrid width="100%" cellpadding="0" cellspacing="0"
			...
			<table border="0" align="center" cellpadding="0"
				...
				<tr>
					<td>
						<ice:commandButton value="#{etiquetas.lblSi} " action="#{generarReportesHabilidadesVista.action_generarReporte}"/> 
					</td>
					<td>
						<ice:commandButton	action="#{generarReportesHabilidadesVista.action_closeConfirmar}"
