<ice:panelPopup id="confirmarPopup" draggable="true"
	visible="#{ejecutarProcesoVerificacion.visibleConfirmar}" modal="true"
	...
	<f:facet name="body">
		<ice:panelGrid width="100%" cellpadding="0" cellspacing="0"
			...
			<br />
				...
				<tr>
					<td>
						<ice:commandButton value="Si" action="#{ejecutarProcesoVerificacion.actionEjecutarProceso}" onclick="disableButton(this);"/> 
					</td>
					<td>
						<ice:commandButton	action="#{ejecutarProcesoVerificacion.actionCloseConfirmar}"
							value="No" />
					</td>
				</tr>
			</table>
