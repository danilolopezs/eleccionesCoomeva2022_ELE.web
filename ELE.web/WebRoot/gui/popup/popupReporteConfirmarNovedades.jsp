<ice:panelPopup id="confirmarPopup" draggable="true"
	visible="#{consultaNovedadesAplicadasVista.visibleConfirmar}" modal="true"
	...
	<f:facet name="body">
		<ice:panelGrid width="100%" cellpadding="0" cellspacing="0"
			...
			<table border="0" align="center" cellpadding="0"
				...
				<tr>
					<td>
						<ice:commandButton value="#{etiquetas.lblSi} " action="#{consultaNovedadesAplicadasVista.action_generarReporte}"/> 
					</td>
					<td>
						<ice:commandButton	action="#{consultaNovedadesAplicadasVista.action_closeConfirmar}"
