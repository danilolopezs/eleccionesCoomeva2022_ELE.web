<ice:panelPopup id="confirmarPopup" draggable="true"
	visible="#{resumenNovedades.visibleConfirmar}" modal="true"
	...
	<f:facet name="body">
		<ice:panelGrid width="100%" cellpadding="0" cellspacing="0"
			...
			<table border="0" align="center" cellpadding="0"
				...
				<tr>
					<td>
						<ice:commandButton value="#{etiquetas.lblSi} " action="#{resumenNovedades.action_generarReporte}"/> 
					</td>
					<td>
						<ice:commandButton	action="#{resumenNovedades.action_closeConfirmar}"
