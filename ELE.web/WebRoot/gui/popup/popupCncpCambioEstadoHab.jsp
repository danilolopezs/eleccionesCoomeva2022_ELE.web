<ice:panelPopup id="popupVerConceptoInhab" draggable="true"
	visible="#{habilidadAsociadosVista.visibleConcepto}" modal="true"
		...
		<ice:panelGrid width="100%" cellpadding="0" cellspacing="0"
			...
			<center>
				<table>
					...
					<tr>
						<td>
							<ice:inputTextarea value="#{habilidadAsociadosVista.conceptoCambio}"
				...
				<tr>
					<td>
						<ice:commandButton value="#{etiquetas.lblGuardar}"
							action="#{habilidadAsociadosVista.action_guardarCambios}" />


					</td>
					<td>
						<ice:commandButton
							action="#{habilidadAsociadosVista.action_closeConcepto}"
