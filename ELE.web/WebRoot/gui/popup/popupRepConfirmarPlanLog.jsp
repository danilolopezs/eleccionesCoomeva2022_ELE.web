<ice:panelPopup id="confirmarPopup" draggable="true"
	visible="#{reportesPlanchasLog.visibleConfirmar}" modal="true"
	...
	<f:facet name="body">
		<ice:panelGrid width="100%" cellpadding="0" cellspacing="0"
			...
			<br />
				...
				<tr>
					<td>
						<ice:commandButton value="#{etiquetas.lblGenerarPDF}" action ="#{reportesPlanchasLog.generarPdf}"/> 
					</td>
					<td>
						<ice:commandButton	action="#{reportesPlanchasLog.action_closeConfirmar}"
