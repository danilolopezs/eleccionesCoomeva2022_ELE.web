<ice:panelPopup id="detalle" draggable="true" styleClass="formulario"
	visible="#{evaluarPlanchaCCEE.visibleDetalle}" modal="true"
				...
				<table border="1" style="">
					<tr>
						...
						<td>
							<div align="center">
								<ice:outputText
									value="#{evaluarPlanchaCCEE.nroIdentificacionDetalle}"
					...
					<tr>
						...
						<td>
							<div align="center">
								<ice:outputText
									value="#{evaluarPlanchaCCEE.nombreAsociadoDetalle}"
									styleClass="textoLabel" />
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div align="center">
								<ice:outputText value="#{evaluarPlanchaCCEE.profesionDetalle}"
									styleClass="textoLabel" />
							</div>
						</td>
					...
					<tr>
						<td colspan="2">
							<div align="center">
								<ice:inputTextarea value="#{evaluarPlanchaCCEE.inhabilidadesDetalle}" readOnly="true" style = "width: 300px; height: 70px;"
									styleClass="textoLabel" />
							</div>
						</td>
					</tr>
					...
					<tr>
						<th width="70px" align="center" style="color: #D4D4D4">
							<ice:commandButton image="../imagenes/boton_salir.gif"
								action="#{evaluarPlanchaCCEE.action_closeDetalle}" />
						</th>
					</tr>
					<tr>
					</tr>
