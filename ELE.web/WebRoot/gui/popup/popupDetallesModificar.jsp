<ice:panelPopup id="detalle" draggable="true" styleClass="formulario"
	visible="#{verModPlanchaVista.visibleDetalle}" modal="true"
				...
				<table border="1" style="">
					<tr>
						...
						<td>
							<div align="center">
								<ice:outputText
									value="#{verModPlanchaVista.nroIdentificacionDetalle}"
					...
					<tr>
						...
						<td>
							<div align="center">
								<ice:outputText
									value="#{verModPlanchaVista.nombreAsociadoDetalle}"
									styleClass="textoLabel" />
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div align="center">
								<ice:outputText
									value="#{verModPlanchaVista.profesionDetalle}"
									styleClass="textoLabel" />
							</div>
						</td>
				...
				<tr>
					<th width="70px" align="center" style="color: #D4D4D4">
						<ice:commandButton image="../imagenes/boton_salir.gif"
							action="#{verModPlanchaVista.action_closeDetalle}" />
					</th>
				</tr>
				<tr>
				</tr>
