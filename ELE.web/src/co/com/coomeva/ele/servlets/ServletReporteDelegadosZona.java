...
public class ServletReporteDelegadosZona extends HttpServlet {
	...
	throws Exception {
		...
		//List<ResumenCuocienteDTO> list = DelegadoCuocienteElectoral.getInstance().generarInformacionResumenCuociente();
	...
	/*public void executeReport(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			if (encabezados == null || encabezados.equals("")) {
				throw new Exception(
						"No se encontró el parámetro con los encabezados del reporte de asociados inhábiles");
			}
			...
			if(cuocienteElectoral != null){
				...
				datosColumnas[7] = " ";
				datosColumnas[8] = " ";
				datosColumnas[0] = "Total Asociados Habiles";
				datosColumnas[1] = UtilNumber.getInstance().getDecimalFormat(cuocienteElectoral.getTotalAsocHabiles(), "##,###").toString();
				datosFilasExcel.add(datosColumnas);
				
				datosColumnas = datosColumnas.clone();
				datosColumnas[0] = "Total Delegados a Elegir";
				datosColumnas[1] = UtilNumber.getInstance().getDecimalFormat(cuocienteElectoral.getTotalDelegadosElegir(), "##,###").toString();
				datosFilasExcel.add(datosColumnas);
				
				datosColumnas = datosColumnas.clone();
				datosColumnas[0] = "Total Delegados Especiales (Promotores, Empleados)";
				datosColumnas[1] = UtilNumber.getInstance().getDecimalFormat(cuocienteElectoral.getTotalDelegadosEspeciales(), "##,###").toString();
				datosFilasExcel.add(datosColumnas);
				
				datosColumnas = datosColumnas.clone();
				datosColumnas[0] = "Final Total Delegados a Elegir";
				datosColumnas[1] = UtilNumber.getInstance().getDecimalFormat(cuocienteElectoral.getFinalTotalDelegadosElegir(), "##,###").toString();
				datosFilasExcel.add(datosColumnas);
				
				datosColumnas = datosColumnas.clone();
				datosColumnas[0] = "Cuociente";
				datosColumnas[1] = UtilNumber.getInstance().getDecimalFormat(cuocienteElectoral.getCuocienteElectoral(), "##,###.####").toString();
				datosFilasExcel.add(datosColumnas); 
			}
			datosColumnas = new String[9];
			...
			datosColumnas[0] = "Regional";
			datosColumnas[1] = "Zona Electoral";
			datosColumnas[2] = "Hábiles";
			datosColumnas[3] = "Delegados";
			datosColumnas[4] = "Delegados Directos";
			datosColumnas[5] = "Fracción";
			datosColumnas[6] = "Delegado Residuo";
			datosColumnas[7] = "Distribucion Restantes";
			datosColumnas[8] = "Total Delegados";
			datosFilasExcel.add(datosColumnas);

			for (EleCuocienteDelegadosZona registroReporte : delegadosZona) {
				datosColumnas = new String[9];
				if( registroReporte.getCodRegional() != null )
				datosColumnas[0] = validarDato(registroReporte.getDescCodRegional()).toString().trim();
				datosColumnas[1] = validarDato(registroReporte.getDescCodZona()).toString();
				datosColumnas[2] = validarDato(UtilNumber.getInstance().getDecimalFormat(registroReporte.getSumaHabiles(), "##,###")).toString();
				datosColumnas[3] = validarDato(UtilNumber.getInstance().getDecimalFormat(registroReporte.getDelegados(), "##,###.####")).toString();
				datosColumnas[4] = validarDato(UtilNumber.getInstance().getDecimalFormat(registroReporte.getDelegadosDirectos(), "##,###")).toString();
				datosColumnas[5] = validarDato(UtilNumber.getInstance().getDecimalFormat(registroReporte.getFraccion(), "##,###.####")).toString();
				datosColumnas[6] = validarDato(UtilNumber.getInstance().getDecimalFormat(registroReporte.getDelegadosResiduo(), "####")).toString();
				datosColumnas[7] = validarDato(UtilNumber.getInstance().getDecimalFormat(registroReporte.getDistribuidosRestantes(), "####")).toString();
				datosColumnas[8] = validarDato(UtilNumber.getInstance().getDecimalFormat(registroReporte.getTotalDelegadosZona(), "##,###")).toString();
			...
			datosColumnas[0] = "Codigo Regional";
			datosColumnas[1] = "Regional";
			datosColumnas[2] = "Total Delegados";
			datosColumnas[3] = "Porcentaje Delegados";
			datosColumnas[4] = " ";
			datosColumnas[5] = " ";
			datosColumnas[6] = " ";
			datosColumnas[7] = " ";
			...
			for (EleCuocienteRegional registroReporte : delegadosRegional) {
				datosColumnas = new String[9];
				datosColumnas[0] = validarDato(registroReporte.getCodRegional()).toString();
				datosColumnas[1] = validarDato(registroReporte.getDesRegional()).toString().trim();
				datosColumnas[2] = validarDato(UtilNumber.getInstance().getDecimalFormat(registroReporte.getTotalDelegados(), "##,###")).toString();
				datosColumnas[3] = validarDato(UtilNumber.getInstance().getDecimalFormat(registroReporte.getRelacionDelegados(), "##,###.##")).toString().concat("%");
				datosColumnas[4] = " ";
				datosColumnas[5] = " ";
				datosColumnas[6] = " ";
				datosColumnas[7] = " ";
			...
			reporteExcel.setNombreHoja("Registros Delegados por Zona Electoral " + tipoHabilidad);
			reporteExcel.setTituloReporte("Reporte Delegados " + tipoHabilidad
					+ " - Total Registros " + delegadosZona.size());
