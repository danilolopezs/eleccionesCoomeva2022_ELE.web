...
public class LogicaGenerador {
	...
	public ByteArrayOutputStream generarExcel() throws Exception{
		...
		try {
			...
			WritableSheet sheet = workbook.createSheet(LoadProperties.getInstance().getLoadBundlePropiedades().getProperty("nombrePestaña").toString(),0);
			...
			String ttlNumeroPlancha = LoadProperties.getInstance().getLoadBundlePropiedades().getProperty("ttlNumeroPlancha");
//			String ttlDocumentoCabeza = LoadProperties.getInstance().getLoadBundlePropiedades().getProperty("ttlDocumentoCabeza");
			String ttlCargosDirectivos = LoadProperties.getInstance().getLoadBundlePropiedades().getProperty("ttlCargosDirectivos");
//			String ttlOtrosEstudios = LoadProperties.getInstance().getLoadBundlePropiedades().getProperty("ttlOtrosEstudios");
			...
			String ttlPrincipales = LoadProperties.getInstance().getLoadBundlePropiedades().getProperty("ttlPrincipales");
			String ttlSuplentes = LoadProperties.getInstance().getLoadBundlePropiedades().getProperty("ttlSuplentes");
			String ttlNombreCompleto = LoadProperties.getInstance().getLoadBundlePropiedades().getProperty("ttlNombreCompleto");
...
//			String ttlProfesion = LoadProperties.getInstance().getLoadBundlePropiedades().getProperty("ttlProfesion");
			...
			for (ElePlanchaDTO elePlanchaDTO : listPlanchas) {
				if (!zonaActual.equalsIgnoreCase(elePlanchaDTO.getEleZonas().getCodZona())) {
					...
					sheet.addCell(new Label(0,cont+1,ttlZona+" N° "+elePlanchaDTO.getEleZonas().getCodZona()+" "+elePlanchaDTO.getEleZonas().getNomZona(),cellhdFormatZona));
					cont++;
				}
				sheet.addCell(new Label(0,cont+1,ttlNumeroPlancha+" "+elePlanchaDTO.getNroPlancha().toString(),cellhdFormatNumero));
				cont++;
...
//				cont++;
				...
				cont++;
				sheet.addCell(new Label(0,cont+1,DelegadoPlanchas.getInstance().formatearCadena(elePlanchaDTO.getEleCabPlanchaDTO().getNombreCompleto()),cellhdFormat));
				cont++;
...
//				cont++;
				sheet.addCell(new Label(0,cont+1,DelegadoPlanchas.getInstance().formatearCadena(elePlanchaDTO.getEleCabPlanchaDTO().getProfesion().toString()),cellhdFormat));
				cont++;
				...
				for (EleExperienciaLaboral experiencia : list) {
					...
					cont++;
					sheet.addCell(new Label(0,cont+1,DelegadoPlanchas.getInstance().formatearCadena(experiencia.getCargo()),cellhdFormat));
					cont++;
					sheet.addCell(new Label(0,cont+1,ttlEmpresa,cellhdFormatBold));
					cont++;
					sheet.addCell(new Label(0,cont+1,DelegadoPlanchas.getInstance().formatearCadena(experiencia.getEmpresa()),cellhdFormat));
					cont++;
					break;
				}
				...
				cont++;
				sheet.addCell(new Label(0,cont+1,DelegadoPlanchas.getInstance().formatearCadena(elePlanchaDTO.getEleCabPlanchaDTO().getCargosDirectivos().toString()),cellhdFormat));
				cont++;
...
//				cont++;
				...
				for (ElePrincipalesDTO elePrincipalesDTO : listaPrincipales) {
					sheet.addCell(new Label(0,cont+1,DelegadoPlanchas.getInstance().formatearCadena(elePrincipalesDTO.getNombreCompleto()),cellhdFormat));
					cont++;
					sheet.addCell(new Label(0,cont+1,DelegadoPlanchas.getInstance().formatearCadena(elePrincipalesDTO.getProfesion()),cellhdFormat));
					cont++;
				}
				...
				for (EleSuplentesDTO eleSuplentesDTO : listaSuplentes) {
					sheet.addCell(new Label(0,cont+1,DelegadoPlanchas.getInstance().formatearCadena(eleSuplentesDTO.getNombreCompleto()),cellhdFormat));
					cont++;
					sheet.addCell(new Label(0,cont+1,DelegadoPlanchas.getInstance().formatearCadena(eleSuplentesDTO.getProfesion()),cellhdFormat));
					cont++;
				}
	...
	public ByteArrayOutputStream generarReporteHabilesInhabilesExcel(List<EleAsociadoDatosDTO> listAsociadosHabiles, String tipoReporte) throws Exception{
		...
		try {
			...
			String ttlNumeroDocumento = loaderResourceElements.getKeyResourceValue(ConstantesProperties.NOMBRE_ARCHIVO_ETIQUETAS_WEB, "lblreporteNumeroDocumento");
			...
			String ttlProfesion = loaderResourceElements.getKeyResourceValue(ConstantesProperties.NOMBRE_ARCHIVO_ETIQUETAS_WEB, "lblreporteProfesion");			
			String ttlEstadoHabilidad = loaderResourceElements.getKeyResourceValue(ConstantesProperties.NOMBRE_ARCHIVO_ETIQUETAS_WEB, "lblreporteEstadoHabilidad");
		...
		try {
			...
			for (ResumenHabilidadDTO dto : list) {
				...
				for (ResumenZonaHabilidadDTO informe : dto.getListResumen()) {
					...
					sheet.addCell(new Label(4,cont+1,informe.getPorcentajeHabiles().toString()+ "%",cellhdFormat));
					sheet.addCell(new Label(5,cont+1,informe.getTotalInhabilesZona().toString(),cellhdFormat));
					sheet.addCell(new Label(6,cont+1,informe.getPorcentajeInhabiles().toString() + "%",cellhdFormat));
				...
				sheet.addCell(new Label(4,cont+1,dto.getPorcentajeHabiles().toString() + "%",cellhdFormatBoldRight));
				sheet.addCell(new Label(5,cont+1,dto.getTotalInhabilesZona().toString(),cellhdFormatBoldRight));
				sheet.addCell(new Label(6,cont+1,dto.getPorcentajeInhabiles().toString() + "%",cellhdFormatBoldRight));
	...
	public ByteArrayOutputStream generarResumenNovedades(List<ResumenNovedadesDTO> list) throws Exception{
		...
		try {
			...
			sheet.addCell(new Label(2,cont+1,ttlZona,cellhdFormatBold));
			sheet.addCell(new Label(3,cont+1,ttlNumeroNovedades,cellhdFormatBold));
			sheet.addCell(new Label(4,cont+1,ttlPorcentajeNovedades,cellhdFormatBold));
			...
			for (ResumenNovedadesDTO dto : list) {
				...
				for (ResumenZonasNovedadesDTO informe : dto.getList()) {
					sheet.addCell(new Label(2,cont+1,informe.getZona().toString(),cellhdFormatLeft));
					sheet.addCell(new Label(3,cont+1,informe.getNumeroNovedades().toString(),cellhdFormat));
					sheet.addCell(new Label(4,cont+1,LogicaInformeResumen.round((Double.valueOf(informe.getPorcentajeNovedades())*100), 2)+"%",cellhdFormat));					
					cont++;
				}
				...
				sheet.mergeCells(0, cont+1, 2, cont+1);
				sheet.addCell(new Label(3,cont+1,dto.getTotalNumeroNov().toString(),cellhdFormatBold));
				sheet.addCell(new Label(4,cont+1,LogicaInformeResumen.round(Double.valueOf(dto.getTotalPorcentajeNov())*100, 2)+"%",cellhdFormatBold));
				...
				if (showTitle) 
				{
					...
					sheet.addCell(new Label(2,cont,ttlZona,cellhdFormatBold));
					sheet.addCell(new Label(3,cont,ttlNumeroNovedades,cellhdFormatBold));
					sheet.addCell(new Label(4,cont,ttlPorcentajeNovedades,cellhdFormatBold));
	...
	public ByteArrayOutputStream generarCoucienteElectoral(List<EleCuocienteRegional> regList, List<EleCuocienteDelegadosZona> list, EleCuocienteElectoral cuocienteElectoral) throws Exception{
		...
		try {
			...
			String ttlTotalDelegadosRestantes = "Total Delegados (distribución restantes)";
			...
			sheet.addCell(new Label(1, 4, cuocienteElectoral.getTotalDelegadosEspeciales().toString(), cellhdFormatRight));
			sheet.addCell(new Label(0, 5, ttlTotalFinalDeleg, cellhdFormat));
			sheet.addCell(new Label(1, 5, cuocienteElectoral.getFinalTotalDelegadosElegir().toString(), cellhdFormatBoldRight));
			...
			for (EleCuocienteDelegadosZona dto : list) {
				...
				sheet.addCell(new Label(2,cont,String.valueOf((dto.getSumaHabiles() - dto.getSumaNovedades() + dto.getSumaEspHabiles())),cellhdFormatRight));
				sheet.addCell(new Label(3,cont,dto.getSumaNovedades().toString(),cellhdFormatRight));
				sheet.addCell(new Label(4,cont, String.valueOf(dto.getSumaHabiles() + dto.getSumaEspHabiles()),cellhdFormatRight));
				
				sheet.addCell(new Label(5,cont, String.valueOf((dto.getSumaEspHabiles() - dto.getSumaNovedadesEsp())),cellhdFormatRight));
				...
				sheet.addCell(new Label(9,cont,String.valueOf(LogicaInformeResumen.round(dto.getFraccion() + dto.getDelegadosDirectos(), 4)),cellhdFormatRight));
			...
			// Creo las celdas vacías para agruparlas
			for (int i = 1; i < 7; i++) 
			{
			...
			for (EleCuocienteRegional dto : regList) {
				...
				sheet.addCell(new Label(indx+3,cont, dto.getRelacionDelegados().toString()+"%",cellhdFormatCenter));
				sheet.addCell(new Label(indx+6,cont, "1",cellhdFormatCenter));
				sheet.addCell(new Label(indx+7,cont, String.valueOf(dto.getTotalDelegados().intValue() + 1 ),cellhdFormatBoldCenter));
				sheet.addCell(new Label(indx+8,cont, String.valueOf((dto.getTotalDelegados().intValue() + 1))+",00%",cellhdFormatRight));				
			...
			sheet.addCell(new Label(indx+3,cont,String.valueOf((int) LogicaInformeResumen.round(sumaRelacionPorc, 0)) + "%" ,cellhdFormatBoldCenterNoBorders));
	...
	public ByteArrayOutputStream generarReportePlanchasEstado(List<PlanchaPorEstadoDTO> list) throws Exception{
		...
		try {
			...
			for (PlanchaPorEstadoDTO dto : list) {				
				sheet.addCell(new Label(0,cont+1,dto.getNumeroPlancha()!= null?dto.getNumeroPlancha().toString():"",cellhdFormat));
	 ...
	 * @since 2016-08-23
	 * 
	 * Metodo para generar el reporte Jasper de RESOLUCIÓN DE ADMISIÓN DE PLANCHAS
	 * 
	 * @param zonaElectoral
	 ...
	 * @return
	 */
	public JasperPrint reporteResolucionAdmisionPlanchas_FT_172(String zonaElectoral, String nombreAsociado, String numResolucion, String numActa, Date fecha,
			String ciudadZona, String dia, String mes, String anio, String rutaImagen, String rutaReporte)throws Exception
	{
	 ...
	 * @since 2016-08-23
	 * 
	 * Metodo para generar el reporte Jasper de RESOLUCIÓN DE RECHAZO DE PLANCHAS
	 * 
	 * @param zonaElectoral
	 * @param nombreAsociado
	 * @param numResolucion
	 ...
	 * @throws Exception
	 */
	public JasperPrint reporteResolucionRechazoPlanchas_FT_173(String zonaElectoral, String nombreAsociado, String numResolucion,String cedulaAsociado, String numActa, Date fecha, String dia, 
			String mes, String anio, String razones, String mesActa, String rutaImagen, String rutaReporte)throws Exception
	{
		JasperPrint jasperPrint = null;
		try 
		{
	 ...
	 * @since 2016-08-23
	 * 
	 * Metodo para generar el reporte Jasper de 
	 * CERTIFICACIÓN DE CUMPLIMIENTO PARA SER ELEGIDO DELEGADO(formato CO-FT-176)
	 * 
	 * 
	 * @return
	 * @throws Exception
	 */
	public JasperPrint reporteCumplimientoDelegado_FT_176(String nombreAsociado, String numPlancha, String nombreRepresen, List<String> respustas, String rutaImagen, String rutaReporte)throws Exception
	{
		JasperPrint jasperPrint = null;
		try 
		{
	 ...
	 * @since 2016-08-23
	 * 
	 * Metodo para generar el reporte Jasper de CONSTANCIA DE RADICACIÓN Y RECIBO DE PLANCHAS(formato CO-FT-208)
	 * 
	 * @param zonaElectoral
	 * @param ciudadZona
	 * @param nombreAsociado
	 ...
	 * @throws Exception
	 */
	public JasperPrint reporteConstanciaRadicacionPlanchas_FT_208(String zonaElectoral, Date fecha, String numComision, String ciudadZona, String nombreAsociado, String cedulaAsociado, 
			String ciudadCedula, String dia,String mes, String anio, String nombreEntrega, String nombreRecibe, String rutaImagen, String rutaReporte)throws Exception
	{
		JasperPrint jasperPrint = null;
		try 
		{
	 ...
	 * @throws Exception
	 */
	public JasperPrint reporteInscripcionPlanchas_FT_210(String zonaElectoral, String ciudad, Date fecha, String rutaImagen, String rutaReporte)throws Exception
	{
		JasperPrint jasperPrint = null;
		try 
		{
	 ...
	 * 
	 * Metodo para generar el reporte Jasper de 
	 * RESOLUCIÓN QUE RESUELVE RECURSOS INTERPUESTOS EXTEMPORANEAMENTE(formato CO-FT-753)
	 * 
	 * @return
	 * @throws Exception
	 */
	public JasperPrint reporteResolucionExtemporaneamente_FT_753(String zonaElectoral, Date fecha, String nombreAsociado, String nombreComision,
			String resolucion,  String diaPresentado, String dia, String mes, String anio, String rutaImagen, String rutaReporte)throws Exception
	{
		JasperPrint jasperPrint = null;
		try 
		{
	 ...
	 * 
	 * Metodo para generar el reporte Jasper de 
	 * RESOLUCIÓN QUE DENIEGA UN RECURSO DE REPOSICIÓN Y NO CONCEDE APELACIÓN POR NO SER SOLICITADO
	 *
	 * @return
	 * @throws Exception
	 */
	public JasperPrint reporteResolucionDeniega_FT_459(String zonaElectoral, String nombreComision,String nombreAsociado,
			String resolucionImpugnada, Date fecha, String resolucion, String argumento, String nombrePresidente, String nombreSecretario,
	 ...
	 * 
	 * Metodo para generar el reporte Jasper de 
	 * RESOLUCIÓN QUE RESUELVE UN RECURSO DE REPOSICIÓN EN CONTRA Y REMITE LA APELACIÓN
	 * @return
	 * @throws Exception
	 */
	public JasperPrint reporteResuelveReposicion_FT_460(String zonaElectoral, String nombreComision,String nombreAsociado,
			String resolucionImpugnada, Date fecha, String resolucion, String argumento, String nombrePresidente, String nombreSecretario,
			String rutaImagen, String rutaReporte)throws Exception
	{
		JasperPrint jasperPrint = null;
	 ...
	 * 
	 * Metodo para generar el reporte Jasper de 
	 * RESOLUCIÓN QUE RESUELVE UN RECURSO DE APELACIÓN FAVORABLE
	 * @return
	 * @throws Exception
	 */
	public JasperPrint reporteResuelveApelacion_FT_461( String acta, String nombreAsociado,
			String resolucionApelada, String resolucionComision, Date fecha, String actaTribunal, 
			String argumento, String desicion, String nombrePresidente, String nombreSecretario,
			String rutaImagen, String rutaReporte)throws Exception
	{
		JasperPrint jasperPrint = null;
		try 
	 ...
	 * 
	 * Metodo para generar el reporte Jasper de 
	 * RESOLUCIÓN QUE RESUELVE UN RECURSO DE APELACIÓN EN CONTRA
	 * @return
	 * @throws Exception
	 */
	 ...
	 * @return
	 */
	public JasperPrint reporteResolucionInadmisionPlancha_FT_209(String zonaElectoral, String anio, String mes, String dia,Date hora,
			String nombreAsociado,String cedulaAsociado, String resolucion, String acta,  Date fecha, String ciudad,
			String razon1, String razon2, String razon3, String razon4,String formulario,String rutaReporte)throws Exception
	{
		JasperPrint jasperPrint = null;
		try 
		{
	 ...
	 * @throws Exception
	 */
	public JasperPrint reporteResolucionFavorable_FT_458(String zonaElectoral, String nombreComision,String nombreAsociado,
			String resolucionImpugnada, Date fecha, String resolucion, String argumento, String nombrePresidente, String nombreSecretario,
			String resolucionMod, String decision, String rutaImagen, String rutaReporte)throws Exception
	{
		JasperPrint jasperPrint = null;
		try 
		{
